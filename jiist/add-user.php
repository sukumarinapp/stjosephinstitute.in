...
if (isset($_POST['submit'])) {
    ...
    if ($count >= 1) {
        ...
        $stmt = $conn->prepare("INSERT INTO jiier_users (centre_id,full_name,email,status,password,mobile,address,user_type,user_id,lastup_date) VALUES (?,?,?,?,?,?,?,?,?,?)");

        $stmt->bind_param("ssssssssss",$centre_id,$full_name,$email,$status,$password,$mobile,$address,$user_type,$user_id,$lastup_date);
              ...
              <div class="col-md-12">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="full_name" required="required" name="full_name" placeholder="Full Name">
                  </div>
                <!--  <div class="form-group">
