...
$page = "Programs";
include "config.php";
$degree_type_id = $_GET['degree_type_id'];
            ...
            <div class="row">
                <div class="span12">
                    ...
                    <div id="myCarousel" class="myCarousel carousel slide">
                        ...
                        ?>
                                    <h1><b><?php echo $row3['course_name']; ?></b></h1>
									<?php } ?>	
                                    <hr>
                                </section>
                                <ul class="thumbnails">
                                            ...
                                            while ($row2 = mysqli_fetch_assoc($result2)) {
                                                ...
                                                <tr>
                                                 ...
                                                 <td> <?php echo $row2['year']; ?></td>
																																						                                ...
																																						                                <td>
<a type="button" class="btn btn-secondary" href="online-application-form.php?id=<?php echo $row2['id']; ?>">Apply</a>
