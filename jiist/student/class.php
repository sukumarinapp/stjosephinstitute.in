              ...
              <div class="card card-stats" style="box-shadow: 0 1px 4px 0 rgb(0 0 0 / 35%)!important">
                <div class="card-header card-header-warning card-header-icon">
                  <div style="width: -webkit-fill-available; margin-right: unset" class="card-icon " >
                   <h1 style="font-weight:bold;margin-bottom:5px;z-index:-9999;text-align: center;color: white;" class="card-category " ><span class="caret"></span><?php echo $row['semester_list']; ?></h1 >
...
?>  
      <tr>
        <td style="font-weight:bold;text-align: left;" ><?php echo $row2['subject_name']; ?></td>
                <td><a style="font-weight:bold;" href="#" onclick="showvideo(event,<?php echo $row2['id']; ?>)"><i class="material-icons">play_circle_filled</i></a></td>
