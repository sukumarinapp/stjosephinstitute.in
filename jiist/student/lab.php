      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;"> Virtual Laboratory</a>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-warning card-header-icon">
                  <div class="card-icon" style="background-image: linear-gradient(yellow,#efff0000);margin-right: unset; float: unset;box-shadow: unset;">
                    <i class="material-icons">content_copy</i>
                    <h3 style="text-align: center;
    color: white;
    font-size: inherit;" class="card-title">Physics Laboratory
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-success card-header-icon">
                  <div class="card-icon" style="background-image: linear-gradient(red,#efff0000);margin-right: unset; float: unset;box-shadow: unset;">
                    <i class="material-icons">content_copy</i>
                    <h3 style="text-align: center;
    color: white;
    font-size: inherit;" class="card-title">Chemistry Laboratory
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-danger card-header-icon">
                  <div class="card-icon" style="background-image: linear-gradient(blue,#efff0000);margin-right: unset; float: unset;box-shadow: unset;">
                    <i class="material-icons">content_copy</i>
                    <h3 style="text-align: center;
    color: white;
    font-size: inherit;" class="card-title">Mechanical Laboratory
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-info card-header-icon">
                  <div class="card-icon" style="background-image: linear-gradient(green,#efff0000);margin-right: unset; float: unset;box-shadow: unset;">
                    <i class="material-icons">content_copy</i>
                    <h3 style="text-align: center;
    color: white;
    font-size: inherit;" class="card-title">ECE Laboratory
           ...
           <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-warning card-header-icon">
                  <div class="card-icon" style="background-image: linear-gradient(lime,#efff0000);margin-right: unset; float: unset;box-shadow: unset;">
                    <i class="material-icons">content_copy</i>
                    <h3 style="text-align: center;
    color: white;
    font-size: inherit;" class="card-title">Biotechnology Laboratory
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-success card-header-icon">
                  <div class="card-icon" style="background-image: linear-gradient(purple,#efff0000);margin-right: unset; float: unset;box-shadow: unset;">
                    <i class="material-icons">content_copy</i>
                    <h3 style="text-align: center;
    color: white;
    font-size: inherit;" class="card-title">CSC Laboratory
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-danger card-header-icon">
                  <div class="card-icon" style="background-image: linear-gradient(teal,#efff0000);margin-right: unset; float: unset;box-shadow: unset;">
                    <i class="material-icons">content_copy</i>
                    <h3 style="text-align: center;
    color: white;
    font-size: inherit;" class="card-title">Electrical Laboratory
              ...
              <div class="card card-stats">
                <div class="card-header card-header-info card-header-icon">
                  <div class="card-icon" style="background-image: linear-gradient(red,#efff0000);margin-right: unset; float: unset;box-shadow: unset;">
                    ...
                    <h3 style="text-align: center;
    color: white;
    font-size: inherit;" class="card-title">Civil Laboratory
