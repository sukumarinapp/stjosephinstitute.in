      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Live IIT</a>
          ...
          <div class="col-lg-4 col-md-6 col-sm-12">
              <div class="card card-chart">
                <div class="card-header card-header-success">
                  <iframe width="100%" height="200" src="https://www.youtube.com/embed/ijYARC4AhDc" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
             ...
             <div class="col-lg-4 col-md-6 col-sm-12">
              <div class="card card-chart">
                <div class="card-header card-header-success">
                  <iframe width="100%" height="200" src="https://www.youtube.com/embed/aLQpArnOnDI" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
             ...
             <div class="col-lg-4 col-md-6 col-sm-12">
              <div class="card card-chart">
                <div class="card-header card-header-success">
                  <iframe width="100%" height="200" src="https://www.youtube.com/embed/9T4ZLsr5ZVs" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
<div class="row">
          <div class="col-lg-4 col-md-6 col-sm-12">
              <div class="card card-chart">
                <div class="card-header card-header-success">
                  <iframe width="100%" height="200" src="https://www.youtube.com/embed/t51hOCs-Vog" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
             ...
             <div class="col-lg-4 col-md-6 col-sm-12">
              <div class="card card-chart">
                <div class="card-header card-header-success">
                  <iframe width="100%" height="200" src="https://www.youtube.com/embed/eGAu0fKvmtc" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
