              ...
              <div class="card card-stats" style="box-shadow: 0 1px 4px 0 rgb(0 0 0 / 35%)!important">
                <div class="card-header card-header-warning card-header-icon">
                  <div style="width: -webkit-fill-available; margin-right: unset;" class="card-icon " >
                   <h1 style="text-align: center;color: white;" class="card-category " ><span class="caret"></span><a href="tube.php?video=<?php echo $row['video']; ?>" ><img width="70" height="70" src="video.png" /></a></h1 >
