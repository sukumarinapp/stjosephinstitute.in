...
<head>
  ...
  <title>Student Follow JIIER</title>
      ...
      <div class="container-fluid">
	   ...
	   <div class="card">
            <div class="card-header">
              <h3 class="card-title">Student Follow Details</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
				  ...
				  <td>
								...
								<a class="btn btn-info fa fa-edit" href="add-student-follow.php?id=<?php echo $row['id']; ?>" title="Add Follow "></a>
