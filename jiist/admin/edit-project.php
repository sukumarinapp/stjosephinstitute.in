...
if (isset($_POST['submit'])) {
  ...
  $stmt = $conn->prepare("UPDATE jiier_project set course_id=?,title=? where id=?");
  $stmt->bind_param("sss",$course_id,$title,$id);
...
?>
                  ...
                  <div class="form-group">
                    <label for="project">Project Format(Word Document)</label>
