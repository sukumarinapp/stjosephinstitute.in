...
if(isset($_POST['submit'])){
	...
	$mail->Subject = "Online Affiliation Centers";
	$mail->MsgHTML($tag);
...
$status = trim($_POST['status']);
	...
	$stmt = $conn->prepare("INSERT INTO jiier_users (centre_id,name_of_the_organization,type_of_organization,address,year_of_establishment,year_of_experience,center_total_area,no_of_class_rooms,no_of_laboratories,no_of_staff_available,remark_if_any,pan_no_of_organization,mobile_number,email,website,institute_profile_promoter_profile,status,user_type) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");

        $stmt->bind_param("ssssssssssssssssss", $centre_id,$name_of_the_organization,$type_of_organization,$address,$year_of_establishment,$year_of_experience,$center_total_area,$no_of_class_rooms,$No_of_laboratories,$no_of_staff_available,$remark_if_any,$pan_no_of_organization,$mobile_number,$email,$website,$institute_profile_promoter_profile,$status,$user_type);
...
<head>
    <meta charset="utf-8">
    <title>Online Affiliation Form St.Joseph Institute Of Integrated Science And Technology  </title>
                                                ...
                                                <table width="475px">
                                                    <tr>
													 ...
													 <label for="pan_no_of_organization">
                                                       ...
                                                       <input type="tel" name="email"  maxlength="200" size="30" style="width:300px;">
