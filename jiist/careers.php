                            ...
                            <form class="cmxform form-horizontal" id="postEnquiry" enctype="multipart/form-data" method="post" action="">
								...
								<div class="form-group">
								 ...
								 <div class="form-group">
									...
									<div class="form-group">
									<label class="control-label col-md-3 prayerReqLbl" for="fullAddress"> Photo</label>
									<div class="col-md-9"><input type="file" name="photo" class="form-control" type="file"></div>
